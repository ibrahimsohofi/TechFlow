...
const analyticsData = {
  ...
  aiMetrics: {
    ...
    tokensUsed: 2847392,
    modelsUsed: ['GPT-4 Turbo', 'Claude-3 Sonnet', 'Mistral-7B']
  },
  compliance: {
  ...
  proxyPerformance: [
    ...
    { provider: 'SmartProxy', successRate: 94.1, avgLatency: 1580, cost: 432.10, country: 'Residential' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">DataVault Pro Analytics</h1>
                <p className="text-sm text-gray-500">Enterprise Web Scraping Performance Dashboard</p>
              </div>
            </div>
          ...
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-3xl font-bold tracking-tight bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                Advanced Scraping Analytics
              </h2>
              <p className="text-gray-600 mt-2">
                Real-time monitoring and insights for enterprise web scraping operations
              </p>
            </div>
          </div>
