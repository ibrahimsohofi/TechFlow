    ...
    <footer className="border-t bg-muted/30">
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5">
          <div className="flex flex-col space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Enterprise-grade data intelligence platform for transforming raw data into actionable insights.
            </p>
          </div>
          ...
          <div className="flex flex-col space-y-3">
            ...
            <Link href="/api-reference" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
              API Reference
            </Link>
        ...
        <div className="mt-12 pt-8 border-t flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} DataVault Pro. All rights reserved.
          </p>
