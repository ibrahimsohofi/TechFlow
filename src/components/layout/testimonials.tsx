...
const testimonials: Testimonial[] = [
  {
    quote:
      "TechFlow Pro transformed our competitive intelligence. We now monitor 50,000+ product listings daily and reduced our data collection costs by 80%. The ROI was immediate.",
    author: "Sarah Chen",
  ...
  {
    quote:
      "We use TechFlow Pro to track real estate listings across 25 markets. The data accuracy and real-time updates give us a significant competitive advantage in property investments.",
    author: "Jennifer Liu",
  ...
  {
    quote:
      "As a research institution, data integrity is crucial. TechFlow Pro's validation and error handling have been exceptional, supporting our academic publications with reliable datasets.",
  ...
  {
    quote:
      "TechFlow Pro handles complex JavaScript-heavy sites that other tools couldn't touch. Our lead generation campaigns are now 3x more effective with higher quality data.",
    author: "Emma Watson",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            See how companies across industries are transforming their data operations with TechFlow Pro
          </p>
        </div>
