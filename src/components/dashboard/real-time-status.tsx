...
import { useJobUpdates, useNotifications } from '@/hooks/use-realtime';
import {
  LucideWifi,
  LucideWifiOff,
  LucidePlay,
...
export function RealTimeStatus() {
  const { connected: jobsConnected, error: jobsError, jobs } = useJobUpdates();
  const {
  ...
  const error = jobsError || notifError;
